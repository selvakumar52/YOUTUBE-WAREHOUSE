...
#API key connection
def Api_connect():
    Api_Id='AIzaSyAGLsiCMNT6DjXrbfbhDK7g1g3nsTSRPMw'
...
if conn:
    ...
    show_table = st.selectbox("CHOOSE THE TABLE FOR VIEW", ("CHANNELS", "VIDEOS", "COMMENTS"))
...
# Streamlit app
selected_query = st.selectbox("Select the SQL query", list(queries1.keys()))

if st.button("Run Query"):
    
    conn = connect_mysql()
    if conn:
        query = queries1[selected_query] 
